...
func buildManifest(rt runtime) control.Manifest {
	...
	manifest.Description = "Local-first archive for official Claude and ChatGPT conversation exports."
	...
	manifest.Commands = map[string]control.Command{
		...
		"import":   {Title: "Import export", Argv: []string{"aicrawl", "import"}, Mutates: true},
	...
	manifest.Privacy = control.Privacy{
		...
		LocalOnlyScopes:         []string{"claude_export", "chatgpt_export"},
	}
	return manifest
}
